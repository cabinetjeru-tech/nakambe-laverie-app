...
export function AssignmentForm({ assignmentId, allowFiles }: { assignmentId: string; allowFiles: boolean }) {
  ...
  return (
    <form action={action} className="space-y-3">
      ...
      {allowFiles && (
        <Field label="Fichiers (images, PDF, documents — 6 max)" hint="Pour les travaux de graphisme ou photographie, déposez vos images : elles peuvent être analysées visuellement.">
